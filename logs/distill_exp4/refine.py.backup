...
if __name__ == '__main__':
    ...
    if args.model == 'svm':
        ...
        for i in range(5):
            ...
            dataset = StairDataset(dataset_list[i], 'test', transform=data_transform)
            test_loader = DataLoader(dataset, batch_size=1, num_workers=16, shuffle=False, drop_last=False)
            test_and_eval(args, io, model, test_loader, device, eval=False, best_path='./logs/res_finetune_exp/models/model.t7')
